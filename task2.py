...
label_result=Label(root,width=25,height=2,text="",font=("arail",30))
label_result.pack()
...
Button(root,text="=",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: caluculate()).place(x=430,y=500)
root.mainloop
